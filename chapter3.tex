...
\chapter{現在未來}
此體裁檔雖通過機械系作者研究室六本70--80頁左右的碩士論文編譯，340+次{\tt Google}下載及不同{\tt Window}環境測試，相信仍有改進空間。 回報錯誤或有更簡潔的\LaTeX{}/Xe\LaTeX{}寫法，請在下載處以{\tt issue}留言或通知{\tt jclo\char64 cc.ncu.edu.tw}，將盡速了解、更正及誌謝，但非所有提問或要求皆處理，謝謝。
